...
export default function CreateBusiness() {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (data?.success) {
        message.success(data.message || "Business created successfully");
        ...
        message.error(data?.message || "Business creation failed");
      }
    } catch (error) {
      message.error(
    ...
    <Space direction="vertical" size="large" style={{ width: "100%" }}>
      ...
      <Breadcrumb
        items={[
          ...
          {
            title: <Link to="/businesss">Businesss</Link>,
          },
          {
      ...
      <Card style={{ maxWidth: 900, margin: "auto" }}>
        <Space direction="vertical" size="large" style={{ width: "100%" }}>
          ...
          <div>
            ...
            <Text type="secondary">
              Add business details and upload a cover image
            </Text>
          </div>
